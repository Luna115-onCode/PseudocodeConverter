...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-G7HVUO5A.js").then((m) => m);
...
var ToolsService = class _ToolsService {
  ...
  loadJSON(jsonFile) {
    return __async(this, null, function* () {
      try {
        const response = yield fetch(`${jsonFile}.json`);
  ...
  getFormattedCode(code) {
    ...
    const blockStack = [];
    const result = [];
    const endKeywords = this.keywordsDic["end"].name[this.lang];
  ...
  static \u0275fac = function ToolsService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToolsService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ToolsService, factory: _ToolsService.\u0275fac, providedIn: "root" });
};
...
var AppComponent = class _AppComponent {
  ...
  inputText = "";
  highlightedText = "";
  cleanHighlightedText = null;
  constructor(tools, sanitizer) {
    this.tools = tools;
    this.sanitizer = sanitizer;
  }
  ngOnInit() {
    return __async(this, null, function* () {
      this.tools.keywordsDic = yield this.tools.loadJSON("dictionary");
      this.tools.locations = yield this.tools.loadJSON("locations");
      yield console.log("Data: " + this.tools.keywordsDic);
    });
  }
  highlightWords(text) {
    ...
    formattedText.forEach((line) => {
      ...
      const stringMatches = [...lineText.matchAll(/"(.*?)"/g)].map((match2) => match2[0]);
      const numberMatches = [...lineText.matchAll(/(?<!")\b\d+(?:\.\d+)?\b(?!")/g)].map((match2) => match2[0]);
      ...
      Object.values(this.tools.keywordsDic).forEach((keywordObj) => {
  ...
  static \u0275fac = function AppComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(ToolsService), \u0275\u0275directiveInject(DomSanitizer));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 5, consts: [[1, "container"], ["appearance", "outlined"], ["contentEditable", "true", 3, "blur", "innerHTML"], ["cols", "3", "rowHeight", "3:1"], ["mat-flat-button", "", 3, "click"], ["id", "outputCode", 1, "mb-3", "background-white", "form-control"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "mat-card", 1)(2, "mat-card-content", 2);
      \u0275\u0275listener("blur", function AppComponent_Template_mat_card_content_blur_2_listener($event) {
        return ctx.onInputChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(3, "mat-grid-list", 3)(4, "mat-grid-tile")(5, "button", 4);
      \u0275\u0275listener("click", function AppComponent_Template_button_click_5_listener() {
        return ctx.convertCode();
      });
      \u0275\u0275text(6);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "mat-grid-tile")(8, "p");
      \u0275\u0275text(9);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "mat-grid-tile")(11, "button", 4);
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("innerHTML", ctx.cleanHighlightedText, \u0275\u0275sanitizeHtml);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", ctx.tools.locations == null ? null : ctx.tools.locations["buttons"] == null ? null : ctx.tools.locations["buttons"]["convertCode"] == null ? null : ctx.tools.locations["buttons"]["convertCode"][ctx.tools.lang], " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate2("", ctx.tools.locations == null ? null : ctx.tools.locations["settings"] == null ? null : ctx.tools.locations["settings"]["changeLanguage"] == null ? null : ctx.tools.locations["settings"]["changeLanguage"][ctx.tools.lang], ": ", ctx.tools.lang, "");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.tools.locations == null ? null : ctx.tools.locations["settings"] == null ? null : ctx.tools.locations["settings"]["changeLanguage"] == null ? null : ctx.tools.locations["settings"]["changeLanguage"][ctx.tools.lang]);
    }
  }, dependencies: [MatButtonModule, MatButton, MatDividerModule, MatIconModule, MatGridListModule, MatGridList, MatGridTile, MatCardModule, MatCard, MatCardContent], styles: ["\n\nbody[_ngcontent-%COMP%] {\n  background-color: rgba(255, 255, 255, 0);\n}\n.container[_ngcontent-%COMP%] {\n  margin-top: 3%;\n  background-color: rgba(255, 255, 255, 0);\n}\n.background-white[_ngcontent-%COMP%] {\n  white-space: pre-wrap;\n  border: 1px solid #ccc;\n  padding: 10px;\n  min-height: 100px;\n  background-color: antiquewhite;\n}\n/*# sourceMappingURL=app.component.css.map */"] });
};
(() => {
